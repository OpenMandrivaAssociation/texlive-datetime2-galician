...
Source2:	http://mirrors.ctan.org/systems/texlive/tlnet/archive/datetime2-galician.source.r%{version}.tar.xz
BuildArch:	noarch
...
%files
%doc %{_texmfdistdir}/source/latex/datetime2-galician
